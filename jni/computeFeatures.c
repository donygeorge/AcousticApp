...
//
//**********************************************************************************
void Java_edu_ucla_cens_acousticapp_Recorder_audioFeatureExtractionInit(JNIEnv* env, jobject javaThis) {
...
//
//**********************************************************************************
void Java_edu_ucla_cens_acousticapp_Recorder_audioFeatureExtractionDestroy(JNIEnv* env, jobject javaThis) {
...
//
//**********************************************************************************
jdoubleArray Java_edu_ucla_cens_acousticapp_Recorder_features(JNIEnv* env, jobject javaThis, jshortArray array) {
...
void Java_edu_ucla_cens_acousticapp_Recorder_helloLog(JNIEnv * env, jobject this, jstring logThis)
{
    jboolean isCopy;
...
//
//**********************************************************************************
jint Java_edu_ucla_cens_acousticapp_Recorder_energy(JNIEnv* env, jobject javaThis, jshortArray array) {
